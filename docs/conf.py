...
copyright = '2015, Djrill contributors (see AUTHORS.txt)'
...
latex_documents = [
  ('index', 'Djrill.tex', 'Djrill Documentation',
   'Djrill contributors (see AUTHORS.txt)', 'manual'),
]
...
man_pages = [
    ('index', 'djrill', 'Djrill Documentation',
     ['Djrill contributors (see AUTHORS.txt)'], 1)
]
...
texinfo_documents = [
  ('index', 'Djrill', 'Djrill Documentation',
   'Djrill contributors (see AUTHORS.txt)', 'Djrill', 'Mandrill integration for Django.',
   'Miscellaneous'),
]
